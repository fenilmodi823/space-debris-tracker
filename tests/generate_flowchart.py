...
def generate_architecture_flowchart():
    ...
    c2.node('Preprocess', 'Data Preprocessing\n(Extract Keplerian Elements)', fillcolor='#c8e6c9')
    c2.node('Feature', 'Feature Engineering\n(Scalar Velocity, Altitude)', fillcolor='#a5d6a7')
    c2.node('RF', 'Random Forest Classifier\n(Active, Derelict, Debris)', fillcolor='#81c784', shape='Mdiamond')
    c2.node('Math', 'Covariance Matrices &\nMahalanobis Distance (Pc)', fillcolor='#c8e6c9')
    ...
    dot.edge('Math', 'SGP4', label=' Standardized Geodetic Vectors', fontname='Helvetica-Oblique', fontsize='10')
