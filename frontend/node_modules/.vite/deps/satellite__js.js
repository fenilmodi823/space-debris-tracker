...
function sgp4init(satrecInit, options) {
	...
	if (omeosq >= 0 || satrec.no >= 0) {
		satrec.isimp = 0;
		if (rp < 1.034492841559484) satrec.isimp = 1;
		sfour = ss;
		qzms24 = qzms2t;
...
async function createSingleThreadRuntime() {
	const { default: createWasmModuleSingleThread } = await import("./base-release-BmPQbbn2.js");
...
async function createMultiThreadRuntime(options) {
	const { default: createWasmModuleMultiThread } = await import("./pthreads-release-DKY4tfX2.js");
